...
import AccountOrderDetailsPage from './pages/account-order-details/account-order-details.component';
import OrderSearchPage from './pages/order-search/order-search.component';
